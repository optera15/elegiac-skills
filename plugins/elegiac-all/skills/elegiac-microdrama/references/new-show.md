...
6. **Build the bible.** Write world rules, principal wants/wounds/secrets/arcs, relationships, recurring locations/props, dialogue rules, prohibited clichés/content, rating, and rights. Mirror durable facts with character tools and Board artifacts.
...
11. **Produce only Episode 1.** Generate approved clips, separate speech/score/SFX, and lipsync where needed. Use one action/camera instruction per clip. Run cheap drafts before keeper motion; preserve exact quote, deduction/refund, and idempotency facts.
